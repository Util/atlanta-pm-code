...
XS(XS_Clone_clone); /* prototype to pass -Wmissing-prototypes */
XS(XS_Clone_clone)
{
    dXSARGS;
    if (items < 1 || items > 2)
	Perl_croak(aTHX_ "Usage: Clone::clone(self, depth=-1)");
    SP -= items;
    {
	SV *	self = ST(0);
	int	depth;
...
extern "C"
#endif
XS(boot_Clone); /* prototype to pass -Wmissing-prototypes */
XS(boot_Clone)
{
    dXSARGS;
    char* file = __FILE__;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("Clone::clone", XS_Clone_clone, file, "$;$");
