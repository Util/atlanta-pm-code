...
XS(XS_Template__Stash__XS_get); /* prototype to pass -Wmissing-prototypes */
XS(XS_Template__Stash__XS_get)
{
    dXSARGS;
    if (items < 2)
	Perl_croak(aTHX_ "Usage: Template::Stash::XS::get(root, ident, ...)");
    {
	SV *	root = ST(0);
	SV *	ident = ST(1);
	SV *	RETVAL;
...
XS(XS_Template__Stash__XS_set); /* prototype to pass -Wmissing-prototypes */
XS(XS_Template__Stash__XS_set)
{
    dXSARGS;
    if (items < 3)
	Perl_croak(aTHX_ "Usage: Template::Stash::XS::set(root, ident, value, ...)");
    {
	SV *	root = ST(0);
	SV *	ident = ST(1);
	SV *	value = ST(2);
...
XS(XS_Template__Stash__XS_cvsid); /* prototype to pass -Wmissing-prototypes */
XS(XS_Template__Stash__XS_cvsid)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: Template::Stash::XS::cvsid()");
    {
	SV *	RETVAL;
#line 1231 "Stash.xs"
...
extern "C"
#endif
XS(boot_Template__Stash__XS); /* prototype to pass -Wmissing-prototypes */
XS(boot_Template__Stash__XS)
{
    dXSARGS;
    char* file = __FILE__;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXS("Template::Stash::XS::cvsid", XS_Template__Stash__XS_cvsid, file);
    XSRETURN_YES;
}
